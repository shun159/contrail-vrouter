...
struct vr_mproto {
  ...
  int (*mproto_encode)(char *, unsigned int, unsigned int, void *, unsigned int);
  int (*mproto_encode_response)(char *, unsigned int, unsigned int, void *, int);
  int (*mproto_decode)(char *, unsigned int, int (*)(void *, unsigned int, void *), void *);
};
