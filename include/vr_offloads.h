...
__attribute__packed__open__ struct vr_offload_flow {
...
struct vr_offload_ops {
  ...
  int (*voo_flow_set)(struct vr_flow_entry *, unsigned int, struct vr_flow_entry *);
  int (*voo_flow_del)(struct vr_flow_entry *);
  int (*voo_flow_meta_data_set)(unsigned int, unsigned int, void *, unsigned short);
