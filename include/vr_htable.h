...
__attribute__packed__open__ typedef struct vr_hentry {
...
typedef vr_hentry_key (*get_hentry_key)(vr_htable_t, vr_hentry_t *, unsigned int *);
typedef void (*htable_trav_cb)(vr_htable_t, vr_hentry_t *, unsigned int, void *);

vr_htable_t vr_htable_create(struct vrouter *, unsigned int, unsigned int, unsigned int,
                             unsigned int, unsigned int, get_hentry_key);
vr_htable_t vr_htable_attach(struct vrouter *, unsigned int, void *, unsigned int, void *,
                             unsigned int, unsigned int, unsigned int, get_hentry_key);
...
int vr_htable_trav_range(vr_htable_t, unsigned int, unsigned int, htable_trav_cb, void *);
