...
#define VR_FLOW_FLAG1_HBS_MASK (VR_FLOW_FLAG1_HBS_LEFT | VR_FLOW_FLAG1_HBS_RIGHT)

#define VR_FLOW_FLAG_DP_FLAGS                                                                      \
  (VR_FLOW_FLAG_EVICT_CANDIDATE | VR_FLOW_FLAG_EVICTED | VR_FLOW_FLAG_NEW_FLOW |                   \
...
#define VR_FLOW_FAMILY(type) ((type == VP_TYPE_IP6) ? AF_INET6 : AF_INET)
...
__attribute__packed__open__ struct vr_common_flow {
...
__attribute__packed__open__ struct vr_inet_flow {
...
__attribute__packed__open__ struct vr_inet6_flow {
...
__attribute__packed__open__ struct vr_flow {
  union {
...
#define VR_FLOW_HASH_SIZE(type)                                                                    \
  ((type == VP_TYPE_IP6) ? VR_FLOW_IPV6_HASH_SIZE : VR_FLOW_IPV4_HASH_SIZE)
 ...
 * do bit operations
 */
__attribute__packed__open__ struct vr_flow_stats {
  uint32_t flow_bytes;
...
__attribute__packed__open__ struct vr_dummy_flow_entry {
...
__attribute__packed__open__ struct vr_flow_entry {
  vr_hentry_t fe_hentry;
  uint8_t fe_ttl;
  int16_t fe_qos_id;
  struct vr_flow fe_key;
...
extern bool vr_flow_forward(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *);
...
flow_result_t vr_flow_lookup(struct vrouter *, struct vr_flow *, struct vr_packet *,
                             struct vr_forwarding_md *);

flow_result_t vr_inet_flow_lookup(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *);
flow_result_t vr_inet6_flow_lookup(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *);
int vr_inet6_form_flow(struct vrouter *, unsigned short, struct vr_packet *, uint16_t,
                       struct vr_ip6 *, struct vr_flow *, uint8_t, bool, bool);
int vr_inet6_get_flow_key(struct vrouter *, unsigned short, struct vr_packet *, uint16_t,
                          struct vr_flow *, uint8_t);

extern unsigned int vr_inet_flow_nexthop(struct vr_packet *, unsigned short);
extern flow_result_t vr_inet_flow_nat(struct vr_flow_entry *, struct vr_packet *,
                                      struct vr_forwarding_md *);
extern void vr_inet_fill_flow(struct vr_flow *, unsigned int, uint32_t, uint32_t, uint8_t, uint16_t,
                              uint16_t, uint8_t);
extern void vr_inet6_fill_flow(struct vr_flow *, unsigned int, unsigned char *, unsigned char *,
                               uint8_t, uint16_t, uint16_t, uint8_t);
extern void vr_inet6_fill_flow_from_req(struct vr_flow *, struct _vr_flow_req *);
extern void vr_inet6_fill_rflow_from_req(struct vr_flow *, struct _vr_flow_req *);
extern void vr_fill_flow_common(struct vr_flow *, unsigned int, uint8_t, uint16_t, uint16_t,
                                uint8_t, uint8_t);
extern bool vr_inet_flow_is_fat_flow(struct vrouter *, struct vr_packet *, struct vr_flow_entry *);
extern bool vr_inet6_flow_is_fat_flow(struct vrouter *, struct vr_packet *, struct vr_flow_entry *);
extern bool vr_inet_flow_allow_new_flow(struct vrouter *, struct vr_packet *);
extern int vr_inet_get_flow_key(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *,
                                struct vr_flow *, uint8_t);
extern unsigned int vr_reinject_packet(struct vr_packet *, struct vr_forwarding_md *);
...
int vr_inet_form_flow(struct vrouter *, unsigned short, struct vr_packet *, uint16_t,
                      struct vr_flow *, uint8_t, bool);
int vr_flow_flush_pnode(struct vrouter *, struct vr_packet_node *, struct vr_flow_entry *,
                        struct vr_forwarding_md *);
void vr_flow_fill_pnode(struct vr_packet_node *, struct vr_packet *, struct vr_forwarding_md *);
...
extern int16_t vr_flow_get_qos(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *);
unsigned int vr_flow_table_used_oflow_entries(struct vrouter *);
unsigned int vr_flow_table_used_total_entries(struct vrouter *);
int vr_flow_update_ecmp_index(struct vrouter *, struct vr_flow_entry *, unsigned int,
                              struct vr_forwarding_md *);
uint32_t vr_flow_get_rflow_src_info(struct vrouter *, struct vr_flow_entry *);
