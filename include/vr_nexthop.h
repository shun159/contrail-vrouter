...
struct vr_nexthop {
  ...
  int (*nh_validate_src)(struct vr_packet *, struct vr_nexthop *, struct vr_forwarding_md *,
                         void *);
  nh_processing_t (*nh_reach_nh)(struct vr_packet *, struct vr_nexthop *,
                                 struct vr_forwarding_md *);
...
static inline bool vr_nexthop_is_vcp(struct vr_nexthop *nh) {
...
extern int vr_ip_rcv(struct vrouter *, struct vr_packet *, struct vr_forwarding_md *);
extern int nh_output(struct vr_packet *, struct vr_nexthop *, struct vr_forwarding_md *);
