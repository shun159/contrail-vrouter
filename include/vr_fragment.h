...
__attribute__packed__open__ struct vr_fragment_key {
  uint64_t fk_sip_u;
  uint64_t fk_sip_l;
  uint64_t fk_dip_u;
  uint64_t fk_dip_l;
...
__attribute__packed__open__ struct vr_fragment {
...
struct vr_fragment *vr_fragment_get(struct vrouter *, unsigned short, struct vr_ip *);
int vr_v4_fragment_add(struct vrouter *, unsigned short, struct vr_ip *, unsigned short,
                       unsigned short);
int vr_v6_fragment_add(struct vrouter *, unsigned short, struct vr_ip6 *, unsigned short,
                       unsigned short);
void vr_fragment_del(vr_htable_t, struct vr_fragment *);
uint32_t vr_fragment_get_hash(struct vr_packet_node *);
int vr_fragment_assemble(struct vr_fragment **, struct vr_fragment_queue_element *);
void vr_fragment_assemble_queue(struct vr_fragment_queue *);
unsigned int vr_assembler_table_scan(struct vr_fragment **);
int vr_fragment_enqueue(struct vrouter *, struct vr_fragment_queue *, struct vr_packet *,
