...
struct vr_btable_partition *vr_btable_get_partition(struct vr_btable *, unsigned int);
...
static inline unsigned int vr_btable_entries(struct vr_btable *table) { return table->vb_entries; }

static inline unsigned int vr_btable_size(struct vr_btable *table) {
  return table->vb_entries * table->vb_esize;
}

static inline void *vr_btable_get(struct vr_btable *table, unsigned int entry) {
