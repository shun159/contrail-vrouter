...
#define IS_LINK_LOCAL_IP(ip) ((ntohl(ip) & METADATA_IP_MASK) == METADATA_IP_SUBNET)

#define RT_IP_ADDR_SIZE(family) ((family == AF_INET6) ? 16 : 4)
...
extern int vr_fib_mem(struct vrouter *);
