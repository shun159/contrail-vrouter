...
#define VR_BRIDGE_FLAG_MASK(flags) ((flags) & ~(VR_BE_VALID_FLAG | VR_BE_MAC_NEW_FLAG))

#define AGENT_PKT_HEAD_SPACE (sizeof(struct vr_eth) + sizeof(struct agent_hdr))

__attribute__packed__open__ struct agent_hdr {
