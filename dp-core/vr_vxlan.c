...
int vr_vxlan_input(struct vrouter *router, struct vr_packet *pkt, struct vr_forwarding_md *fmd) {
...
static void vr_vxlan_make_req(vr_vxlan_req *req, struct vr_nexthop *nh, unsigned int vnid) {
...
int vr_vxlan_trav_cb(unsigned int index, void *data, void *udata) {
...
int vr_vxlan_dump(vr_vxlan_req *req) {
  int ret;
...
int vr_vxlan_get(vr_vxlan_req *req) {
  int ret = 0;
...
int vr_vxlan_del(vr_vxlan_req *req) {
  struct vrouter *router;
  struct vr_nexthop *nh;
  int ret = 0;
...
int vr_vxlan_add(vr_vxlan_req *req) {
  struct vrouter *router;
...
static void vr_vxlan_destroy(unsigned int index, void *arg) {
