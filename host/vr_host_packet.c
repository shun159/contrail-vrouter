...
int vr_hpacket_copy(unsigned char *dst, struct vr_hpacket *hpkt_src, unsigned int offset,
                    unsigned int len) {
...
void vr_hpacket_free(struct vr_hpacket *hpkt) {
...
struct vr_hpacket *vr_hpacket_alloc(unsigned int size) {
...
struct vr_hpacket *vr_hpacket_clone(struct vr_hpacket *hpkt) {
...
struct vr_hpacket *vr_hpacket_pool_alloc(struct vr_hpacket_pool *pool) {
  struct vr_hpacket *hpkt;
  struct vr_packet *pkt;
...
void vr_hpacket_pool_free(struct vr_hpacket *hpkt) {
...
void vr_hpacket_pool_destroy(struct vr_hpacket_pool *pool) {
...
struct vr_hpacket_pool *vr_hpacket_pool_create(unsigned int pool_size, unsigned int psize) {
  unsigned int i;
